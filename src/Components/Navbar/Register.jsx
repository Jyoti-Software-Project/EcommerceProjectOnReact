...
import './Style-Navbar/Register.css';
...
const Register = () => {
    ...
    return (
        <div className="container-fluid px-0 py-5 myCustomerRegisterContainer user-select-none">
            <form onSubmit={formik.handleSubmit} onReset={formik.handleReset}>
                <table className="container bg-secondary-subtle rounded-4 mySecondCustomerRegisterContainer">
                    <thead>
                        <tr>
                            <th colSpan="3" className="text-center pb-3 pt-5">
                                <div className="position-relative z-3 rounded-circle mx-auto" style={{width: "9rem", boxShadow: "0 0 20px #FFFFFF"}}>
                                    <svg className="position-relative top-0 myCustomerRegisterIcon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" fill="rgba(246, 254, 2, 1)" height="75" width="125" transform="scale(-1, 1)">
                                    ...
                                    <span className="fs-4 fw-semibold fst-italic myCustomerRegisterName position-absolute">Afistracate</span>
                                </div>
                            </th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            <th colSpan="3" className='text-center pt-3 pb-5'>
                                ...
                                <NavLink to="/Navbar/Login" className="fs-5 fw-semibold text-decoration-none myCustomerLoginLink">Login</NavLink>
                            </th>
                        </tr>
                    </tbody>
                </table>
